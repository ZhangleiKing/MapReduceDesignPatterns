...
public class CommentWordCount {
    ...
    public static class WordCountMapper extends Mapper<Object, Text, Text, IntWritable> {
        ...
        public void map(Object key, Text  value, Context context) throws IOException, InterruptedException {
            ...
            txt = txt.replaceAll("'", "");//remove single quote
            txt = txt.replaceAll("[^a-zA-Z]", " ");

            StringTokenizer sti = new StringTokenizer(txt);
            while(sti.hasMoreTokens()) {
                word.set(sti.nextToken());
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        if(otherArgs.length != 2) {
            System.out.println("Usage: CommentWordCount <in> <out>");
            System.exit(2);
        }
